...
public class RealmsMarker extends Marker {
	...
	private static final String UNCOMPLETE_SELECTED_ICON		= "/realms_configurator/faces/resources/images/mmm.gif";
	private static final String COMPLETE_Q_ICON 				= "/realms_configurator/faces/resources/images/marker_q.png";
	private static final String COMPLETE_Q_SELECTED_ICON 		= "/realms_configurator/faces/resources/images/marker_q_selected.png";
	private static final String COMPLETE_I_ICON 				= "/realms_configurator/faces/resources/images/marker_i.png";
	private static final String COMPLETE_I_SELECTED_ICON 		= "/realms_configurator/faces/resources/images/marker_i_selected.png";
	...
	private void updateIcon() {
		if(isComplete()) {
			if(isSelected()) {
				if(! getIsInformation()) {
					setIcon(COMPLETE_Q_SELECTED_ICON);
				} else {
					setIcon(COMPLETE_I_SELECTED_ICON);
				}

			} else if(! getIsInformation()) {
				setIcon(COMPLETE_Q_ICON);
			} else {
				setIcon(COMPLETE_I_ICON);
			}
		} else {
			if(isSelected()) {
